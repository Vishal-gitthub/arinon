...
import logo from "../Assets/Logo/Arinon_Logo_Icon-Blue.svg"
      ...
      return (
            <div className="bg-white text-black px-16 py-6">
                  ...
                  <div className='-mt-8 hidden'>
                        ...
                        <h2 className="text-2xl font-semibold text-[#1d3962] mb-4">Interpretation and Definitions</h2>
                        <h3 className="text-xl font-semibold text-[#1d3962] mb-2">Interpretation</h3>
                        <p className="mb-4 text-lg">
                        ...
                        <h3 className="text-xl font-semibold text-[#1d3962] mb-2">Definitions</h3>
                        <div className="mb-4 text-lg">
                              ...
                              <ul className="list-disc ml-8">
                                    ...
                                    <li>
                                          ...
                                          this Agreement) refers to Manisi, Plot 452, Dwarka Sector 19, New Delhi 110075.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                          <strong>Website</strong> refers to Arinon Digital, accessible from arinon.com.
                                    </li>
                                    <li>
                        ...
                        <h2 className="text-2xl font-semibold text-[#1d3962] mb-4">Collecting and Using Your Personal Data</h2>
                        <h3 className="text-xl font-semibold text-[#1d3962] mb-2">Types of Data Collected</h3>
                        ...
                        <section id="tracking-cookies" className="p-6 bg-gray-100 text-gray-800">
                              <h2 className="text-xl font-bold mb-4">Tracking Technologies and Cookies</h2>
                              <p className="mb-4 text-lg">
                              ...
                              <p className="mt-4">
                                    Cookies can be <span className="font-semibold">"Persistent"</span> or <span className="font-semibold">"Session"</span> Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on TermsFeed website article.
                              </p>
                              <h3 className="text-lg font-bold mt-6">We use both Session and Persistent Cookies for the purposes set out below:</h3>
                              <ul className="list-disc pl-6 space-y-2 mt-4">
                                    <li>
                                          <span className="font-semibold">Necessary / Essential Cookies:</span> <br />
                                          <span className="italic">Type:</span> Session Cookies <br />
                                          <span className="italic">Administered by:</span> Us <br />
                                    ...
                                    <li>
                                          ...
                                          <span className="italic">Type:</span> Persistent Cookies <br />
                                          <span className="italic">Administered by:</span> Us <br />
                        ...
                        <section id="use-of-data" className="p-6 bg-gray-100 text-gray-800">
                              <h2 className="text-xl font-bold mb-4">Use of Your Personal Data</h2>
                              <p className="mb-4 text-lg">
                              ...
                              <h3 className="text-lg font-bold mt-6">We may share Your personal information in the following situations:</h3>
                              <ul className="list-disc pl-6 space-y-2 mt-4">
                        ...
                        <section id="data-retention-deletion" className="p-6 bg-gray-100 text-gray-800">
                              ...
                              <h2 className="text-xl font-bold mb-4">Transfer of Your Personal Data</h2>
                              <p className="mb-4 text-lg">
                              ...
                              <h2 className="text-xl font-bold mb-4">Delete Your Personal Data</h2>
                              <p className="mb-4 text-lg">
                        ...
                        <section className="space-y-8">
                              <h2 className="text-3xl font-semibold text-gray-800">Disclosure of Your Personal Data</h2>

                              <div className="space-y-6">
                                    <h3 className="text-2xl font-semibold text-gray-700">Business Transactions</h3>
                              ...
                              <div className="space-y-6">
                                    <h3 className="text-2xl font-semibold text-gray-700">Law Enforcement</h3>
                                    <p className="text-gray-600">
                              ...
                              <div className="space-y-6">
                                    <h3 className="text-2xl font-semibold text-gray-700">Other Legal Requirements</h3>
                                    <p className="text-gray-600">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
                              ...
                              <div className="space-y-6">
                                    <h3 className="text-2xl font-semibold text-gray-700">Security of Your Personal Data</h3>
                                    <p className="text-gray-600">
                              ...
                              <div className="space-y-6">
                                    <h3 className="text-2xl font-semibold text-gray-700">Children's Privacy</h3>
                                    <p className="text-gray-600">
                              ...
                              <div className="space-y-6">
                                    <h3 className="text-2xl font-semibold text-gray-700">Links to Other Websites</h3>
                                    <p className="text-gray-600">
                        ...
                        <div className="mt-8">
                              ...
                              <ul className="list-disc ml-8 mt-2">
                                    <li>By email: info@arinon.com</li>
                              </ul>
                        </div>
                  </div>
            </div>
