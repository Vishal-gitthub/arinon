...
const IgReel = () => {
    useEffect(() => {
        // Load Instagram's embed script only if it is not already loaded
        if (!window.instgrm) {
            ...
            script.onload = () => {
                // Once the script is loaded, process the Instagram embed
    ...
    return (
        <blockquote 
            ...
            data-instgrm-permalink="https://www.instagram.com/reel/DBb1SlvCdhW/?utm_source=ig_embed&amp;utm_campaign=loading" 
            ...
            <div style={{ padding: "16px" }}>
                <a 
                    href="https://www.instagram.com/reel/DBb1SlvCdhW/?utm_source=ig_embed&amp;utm_campaign=loading" 
                    style={{ 
                        background: "#FFFFFF", 
                        lineHeight: 0, 
                        padding: "0 0", 
